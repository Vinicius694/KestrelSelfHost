...
namespace ICA.Ng.Carpark.WebApi
{
    public class EndPointCreator
    {
        ...
        //private Ng.Service.INamedLoggerFactory _loggerFactory = default!;
        

        //protected zcfux.Logging.ILogger Logger { get; private set; } = default!;

        public EndPointCreator()
        {
            //_loggerFactory = loggerFactory;
           // Logger = loggerFactory.Create(nameof(EndPointCreator));
